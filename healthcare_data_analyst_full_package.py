...
حزمة شاملة لمحلل البيانات - healthcare.gammal.tech
-----------------------------------------------
الملف هذا يحتوي على كل ما تم الاتفاق عليه:
 - SQL جاهز (materialized views, alerts, refresh)
 - سكربت Python لإنشاء بيانات تجريبية، تصورات، وتصدير Excel/CSV
 - قوالب تقارير (Markdown داخل المتغيرات) جاهزة للطباعة أو الاستخدام
 - إرشادات التشغيل و أمثلة cron
 - كل شيء موثق باللغة العربية داخل التعليقات لسهولة الرفع على GitHub

ملاحظة هامة: هذا ملف قوالب/تجريبي. لا تشغّل سكربتات SQL على قواعد الإنتاج قبل المراجعة.
"""
# -----------------------------
# Section 1: SQL (نص SQL كامل جاهز)
# -----------------------------
SQL_KPIS = r'''
-- healthcare_kpis.sql
